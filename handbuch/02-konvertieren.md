...
| `--report DATEI` | Schreibt das Protokoll als JSON. **Benutzen Sie das immer** |
...
Wichtig zu wissen: **diese ID ändert sich, wenn sich die Daten ändern.**
Sie ist keine dauerhafte Kennung. Dauerhaft ist die AVefi-PID, und die kommt
aus dem Handle-System, nicht von hier.
